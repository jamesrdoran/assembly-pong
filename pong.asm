...
DATA SEGMENT PARA 'DATA'
	...
	TEXT_GAME_OVER_MAIN_MENU DB 'Press E to return to the main menu','$' ;text to display the main menu message
	TEXT_MAIN_MENU_TITLE DB 'MAIN MENU','$'                              ;text to display the main menu title
	TEXT_MAIN_MENU_SINGLE_PLAYER DB 'Singleplayer - S KEY','$'           ;text to display the singleplayer message
	TEXT_MAIN_MENU_MULTI_PLAYER DB 'Multiplayer - M KEY','$'             ;text to display the multiplayer message
	TEXT_MAIN_MENU_EXIT DB 'Exit Game - E KEY','$'                       ;text to display the exit message
...
;   shows the main menu message
    MOV AH,02h                                                         ;set the configuration to set the cursor position
    MOV BH,00h                                                         ;set the page number
    MOV DH,0Ah                                                         ;set the line (y)
    MOV DL,04h                                                         ;set the column (x)
    INT 10h                                                            ;execute the configuration

    MOV AH,09h                                                         ;set the configuration to write a string
    LEA DX,TEXT_GAME_OVER_MAIN_MENU                                    ;give DX a pointer to the string
    INT 21h                                                            ;print the string
...
;   if the key is 'R' or 'r', restart the game
    ...
    CMP AL,'r'                                                         ;if the key pressed is 'r' (play again)
    JE RESTART_GAME                                                    ;restart the game
;   if the key is 'E' or 'e', restart the game
    CMP AL,'E'                                                         ;if the key pressed is 'E' (main menu)
    JE EXIT_TO_MAIN_MENU                                               ;return to the main menu
    CMP AL,'e'                                                         ;if the key pressed is 'e' (main menu)
    JE EXIT_TO_MAIN_MENU                                               ;return to the main menu
    RET
    ...
    EXIT_TO_MAIN_MENU:                                                 ;return to the main menu
      MOV GAME_ACTIVE,00h                                              ;set the game as inactive
      MOV CURRENT_SCENE,00h                                            ;set the current scene as the main menu
      RET
  ...
  DRAW_MAIN_MENU PROC NEAR
    ...
    CALL CLEAR_SCREEN                                                  ;clear the screen before drawing the main menu
...
;   shows the menu title
    ...
    MOV AH,09h                                                         ;set the configuration to write a string
    LEA DX,TEXT_MAIN_MENU_TITLE                                        ;give DX a pointer to the string
    INT 21h                                                            ;print the string
...
;   shows the singleplayer message
    ...
    MOV AH,09h                                                         ;set the configuration to write a string
    LEA DX,TEXT_MAIN_MENU_SINGLE_PLAYER                                ;give DX a pointer to the string
    INT 21h                                                            ;print the string
...
;   shows the multiplayer message
    ...
    MOV AH,09h                                                         ;set the configuration to write a string
    LEA DX,TEXT_MAIN_MENU_MULTI_PLAYER                                 ;give DX a pointer to the string
    INT 21h                                                            ;print the string
